...
const opportunities = [
    {
        ...
        customerAddress: "123 Main St, Makati City",
    ...
    },
    {
        ...
        customerAddress: "789 Pine St, Taguig City",
    ...
    },
    {
        ...
        customerAddress: "321 Elm St, BGC",
    ...
    },
    {
        ...
        customerAddress: "654 Maple Dr, Cavite",
    ...
    row.innerHTML = `
        <td>
            <div class="customer-info">
                ...
                <small>${opportunity.customerEmail}</small>
            </div>
        </td>
        <td>
...
function viewOpportunity(opportunityId) {
    ...
    // Populate modal with opportunity details
    document.getElementById('modalCustomerName').textContent = opportunity.customerName;
    document.getElementById('modalCustomerEmail').textContent = opportunity.customerEmail;
    document.getElementById('modalCustomerPhone').textContent = opportunity.customerPhone;
    document.getElementById('modalCustomerAddress').textContent = opportunity.customerAddress;
    
    document.getElementById('modalPropertyName').textContent = opportunity.propertyName;
    document.getElementById('modalPropertyPrice').textContent = new Intl.NumberFormat('en-PH', {
        style: 'currency',
        currency: 'PHP',
        minimumFractionDigits: 0
    }).format(opportunity.propertyPrice);
    document.getElementById('modalPropertyLocation').textContent = opportunity.propertyLocation;
    
    document.getElementById('modalReservationDate').textContent = new Date(opportunity.reservationDate).toLocaleDateString();
    document.getElementById('modalReservationFee').textContent = new Intl.NumberFormat('en-PH', {
        style: 'currency',
        currency: 'PHP',
        minimumFractionDigits: 0
    }).format(opportunity.reservationFee);
    document.getElementById('modalRfPaid').textContent = opportunity.rfPaid ? 'Yes' : 'No';
    document.getElementById('modalStage').textContent = opportunity.stage.toUpperCase();
